...
val TermHeaderBg = Color(0xFF16161A)
val TermPrompt = Color(0xFF818CF8)        // Indigo prompt
val TermText = Color(0xFFE2E8F0)
val TermGreen = Color(0xFF34D399)        // Emerald output
val TermYellow = Color(0xFFFBBF24)
val TermCyan = Color(0xFF38BDF8)
val TermRed = Color(0xFFF87171)
val TermMuted = Color(0xFF64748B)
